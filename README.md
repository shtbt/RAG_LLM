...
[![My Image](https://github.com/shtbt/RAG_LLM/blob/main/RAG_COVER.png)](image.jpg#caption)

<a name="caption"></a>  *This is the caption under the image.*
![Retrieval-Augmented Generation (RAG) — Image generated by DALL-E](https://github.com/shtbt/RAG_LLM/blob/main/RAG_COVER.png)

*Retrieval-Augmented Generation (RAG) — Image generated by DALL-E*
### Introduction
...
and enterprise AI applications. From
[this](https://medium.com/@drjulija/what-is-retrieval-augmented-generation-rag-938e4f6e03d1)
medium blog post, I have borrowed RAG pipeline schema.

<img src="https://github.com/shtbt/RAG_LLM/blob/main/RAG_PIPE.png" style="width:6.5in;height:3.07292in" />
RAG Pipeline in General — Image from [Here](https://medium.com/@drjulija/what-is-retrieval-augmented-generation-rag-938e4f6e03d1)
...
<img src="https://github.com/shtbt/RAG_LLM/blob/main/ollama.png" style="width:1.88194in;height:2.66667in" />[Ollama](https://ollama.com/)
Framework
